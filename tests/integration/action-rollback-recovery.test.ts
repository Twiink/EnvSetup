...
const realRollbackCases: RealRollbackCase[] = [
  ...
  },
  {
    ...
    templateId: 'mysql-template',
    buildParams: (t, d) => ({
      installRootDir: join(t, 'mysql-direct-rb'),
      mysqlManager: 'mysql',
      downloadCacheDir: d,
    }),
  },
  ...
  },
  {
    ...
    templateId: 'redis-template',
    buildParams: (t, d) => ({
      installRootDir: join(t, 'redis-direct-rb'),
      redisManager: 'redis',
      downloadCacheDir: d,
    }),
  },
  ...
  },
  {
    ...
    templateId: 'maven-template',
    buildParams: (t, d) => ({
      installRootDir: join(t, 'maven-package-rb'),
